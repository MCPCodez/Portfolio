  ...
  return (
    <div className='bg-mainBg bg-cover bg-center h-screen w-screen'>
      <div className='grid grid-rows-10 h-screen justify-items-center p-8 md:pb-20'>
        ...
        <p className='text-white text-sm md:text-xl md:font-normal row-span-4 content-center font-bold animate__animated animate__fadeIn animate__delay-1s'>
        ...
        <p className='text-white text-sm md:text-xl md:font-normal row-span-4 font-bold animate__animated animate__fadeIn animate__delay-2s md:row-span-2'>
        ...
        <a href="/contact" className='text-gray-900 text-2xl row-span-1 border border-black content-center p-4 md:pr-10 md:pl-10 rounded-xl bg-teal-300 animate__animated animate__fadeIn animate__delay-3s md:row-span-3 md:h-1/3'>Contact Me</a>
      </div>
    </div>
  )
}
